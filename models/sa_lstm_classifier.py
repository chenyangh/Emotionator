...
class AttentionLSTMClassifier(nn.Module):
    ...
    def load_glove_embedding(self, id2word, glove_path):
        """
        :param id2word:
        :return:
        """
        emb = np.zeros((self.vocab_size, self.embedding_dim))
        with open(glove_path, 'br') as f:
    ...
    def load_fasttext_embedding(self, id2word, fname):
        """
        :param id2word, fname:
        :return:
        """
